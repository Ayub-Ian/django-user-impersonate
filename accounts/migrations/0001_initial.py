# Generated by Django 4.2.13 on 2024-07-04 18:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.BigIntegerField(default=accounts.utils.RandomId('accounts.AppUser'), primary_key=True, serialize=False, unique=True)),
                ('email_verified', models.BooleanField(default=False)),
                ('email_last_verified_at', models.DateTimeField(blank=True, default=None, null=True)),
                ('email', models.EmailField(max_length=254, unique=True)),
                ('unverified_email', models.EmailField(blank=True, default=None, max_length=254, null=True)),
                ...
                ('unregistered', models.BooleanField(default=False, help_text='Designates whether the user is pending invitation and not signed up yet.')),
        ...
        migrations.CreateModel(
            name='Client',
            fields=[
                ('id', models.BigIntegerField(default=accounts.utils.RandomId('accounts.Client'), primary_key=True, serialize=False, unique=True)),
                ...
                ('status', models.CharField(choices=[('active', 'Active'), ('inactive', 'Inactive'), ('suspended', 'Suspended'), ('deleting', 'Deleting')], db_index=True, default='inactive', max_length=16)),
                ('suspend_reason', models.CharField(blank=True, db_index=True, default=None, max_length=16, null=True)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='client',
            name='currency',
            field=models.ForeignKey(default=accounts.models.get_default_currency, on_delete=django.db.models.deletion.CASCADE, to='accounts.currency'),
        ),
        migrations.AddField(
            model_name='client',
            name='users',
            field=models.ManyToManyField(related_name='clients', through='accounts.UserToClient', to=settings.AUTH_USER_MODEL),
        ),
    ]
